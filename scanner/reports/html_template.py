...
<header>
  ...
  <div class="meta">
    ...
    <strong>Generated:</strong> {_esc(generated_at)}&nbsp;&nbsp;
    <strong>Scanner:</strong> v{_esc(tool_version)}<br>
...
<footer>
  Generated by Security Scanner v{_esc(tool_version)} &bull; {_esc(generated_at)} &bull; {total} finding(s)
</footer>
